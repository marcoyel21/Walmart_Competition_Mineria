...
```{r}
library(feather)
write_feather(walmart,"walmart.feather")
write_feather(walmart_test,"walmart_test.feather")
```
 ...
 **AQUÍ VA LA GRAFICA DE MARCO**
 
 **y aquí abajito los nuevos dataframes con las modificaciones que hizo**
